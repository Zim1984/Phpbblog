...
*
* @package phpBB3
* @version $Id: blog_xmlrpc.php,v 1.0.0 2008/06/04 16:53:35 Skippy Exp $
...
include($phpbb_root_path . 'includes/rpc.' . $phpEx);
...
define('WEBLOG_XMLPRPC_USERAGENT','phpBBlog '.$blog_config['version']);
